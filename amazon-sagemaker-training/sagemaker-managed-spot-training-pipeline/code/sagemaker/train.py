...
# https://github.com/aws-samples/amazon-sagemaker-managed-spot-training/blob/main/pytorch_managed_spot_training_checkpointing/source_dir/cifar10.py
...
def train(args):
    ...
    for epoch in range(epoch_number, args.epochs + 1):
        model.train()
